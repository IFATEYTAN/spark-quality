...
export const TRIGGER_SCENARIOS: Record<TriggerKey, TriggerScenario> = {
  ...
  poaExpired: {
    ...
    trigger: "תוקף ייפוי הכוח חלף את התאריך הנוכחי",
    exampleCustomer: {
      name: "דנה פרי · ת.ז. 0••••3 · תוקף פג ב-12.04.2026",
      flag: "POA EXPIRED",
  ...
  aumFrozen: {
    ...
    priority: "P2",
    title: "AUM מוקפא — שיחת בירור",
    pain: "צבירה מעל 30K שיושבת במוצר לא פעיל — תשואה אפס לחיסכון, אפס לסוכן. שיחה אחת מחזירה אותה לפעילות.",
    trigger: "מוצר בסטטוס לא פעיל וצבירה ≥ 30,000 ₪",
    exampleCustomer: {
      name: "תמר בר-לב · גמל 145K ₪ · לא פעיל מאז 2021",
      flag: "AUM FROZEN",
      channel: "שיחת בירור + מייל מסכם",
    },
    outcome: [
      { label: "AUM מוקפא בתיק", value: "—" },
