...
const buildMessage = (customer: Customer, channel: "email" | "whatsapp"): { subject?: string; body: string } => {
  ...
  // Default
  return {
    subject: `${firstName}, עדכון לגבי תיק הביטוח שלך בקואליטי`,
