// Editorial Fintech | מסך העלאת דוח - גרסה נקייה ומאוורתת למצגת
  ...
  return (
    <div className="relative h-[calc(100vh-7rem)] w-full overflow-hidden bg-navy-deep">
      ...
      <div className="absolute inset-0">
        ...
        />
        {/* Subtle overlay - keep right side dark for text, left side visible for atmosphere */}
        ...
        <div className="lg:col-span-8 flex items-center px-8 lg:px-16 py-8">
          <div className="max-w-2xl animate-fade-up w-full">
            ...
            <button
              ...
              onClick={onUpload}
              className={`mt-9 group relative w-full overflow-hidden rounded-lg border-2 p-6 text-right transition-all duration-300 backdrop-blur-md ${
                isDragging
            ...
            >
              ...
              <div className="relative flex items-center gap-5">
                <div className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-gold to-gold-soft text-navy-deep transition-transform group-hover:scale-110 shadow-2xl shadow-gold/30">
                ...
                <div className="flex-1 text-right">
                  ...
                  <div className="mt-1 text-sm text-white/75">
                    או לחצו לבחירת קובץ · תומך .xlsx, .xls
                  </div>
                </div>
                <Upload
              ...
              <div className="relative mt-5 flex items-center justify-between border-t border-white/15 pt-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="label-tag text-[11px] text-gold tracking-widest">
                    דמו אוטומטי
                  </span>
                </div>
                <div className="flex items-center gap-2 text-sm font-semibold text-white/95 transition-colors group-hover:text-gold">
                  השתמש בדוח לדוגמה
          ...
          >
            <div className="border-r-2 border-gold pr-6 text-right">
              <p className="font-display-light text-2xl leading-relaxed text-white/95">
                ...
                הוא נותן לו{" "}
                <span className="font-bold text-gold">כוח על</span>."
              </p>
