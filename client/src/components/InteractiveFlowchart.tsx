...
export const FLOWCHART_DATA: Record<string, FlowchartData> = {
  vip: {
    nodes: [
      ...
      { id: "n5", type: "approval", label: "אישור הסוכן/ת",            detail: "תקציר + כפתור 'אשר ושלח' / 'התאם ידנית'",                       icon: UserCheck },
  ...
  lowYield: {
    nodes: [
      ...
      { id: "n6", type: "approval", label: "אישור הסוכן/ת",              detail: "הסוכן/ת רואים את ההמלצה, יכולים לערוך ולשלוח",                       icon: UserCheck },
  ...
  "190": {
    nodes: [
      ...
      { id: "n6", type: "approval", label: "אישור הסוכן/ת",                  detail: "הסוכן/ת בוחנים את הסימולציה, יכולים לערוך ולאשר",                     icon: UserCheck },
  ...
  risk: {
    nodes: [
      ...
      { id: "n5", type: "approval", label: "אישור מהיר של הסוכן/ת",            detail: "מסך ייעודי 1-קליק עם 'אשר ושלח' / 'התאם ידנית'",                    icon: UserCheck },
  ...
  discount: {
    nodes: [
      ...
      { id: "n6", type: "approval", label: "אישור הסוכן/ת",                      detail: "הסוכן/ת מאשרים את ההצעה - או מתאימה ידנית לפי שיחה עם הלקוח",            icon: UserCheck },
  ...
  coverageGaps: {
    nodes: [
      ...
      { id: "n6", type: "approval", label: "אישור הסוכן/ת",                       detail: "הסוכן/ת בוחנים את ההמלצה ומאשרת או מתאימה",                              icon: UserCheck },
