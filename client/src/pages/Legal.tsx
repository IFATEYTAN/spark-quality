...
function TermsContent() {
  return (
    <>
      ...
      <h2 className="text-xl font-bold text-gold">4. תקופת ניסיון ותשלום</h2>
      <p>
        ניתנת תקופת ניסיון של 14 יום בחינם, ללא צורך בהזנת אמצעי תשלום. בתום הניסיון, על-מנת להמשיך להשתמש,
        יש לבחור חבילה ולהזין אמצעי תשלום. ביטול ניתן בכל עת.
      </p>
