...
- [ ] לאתר את כל כפתורי "הפעל אוטומציות" בקוד ולמפות לקטגוריות
- [ ] להגדיר את שלבי הזרימה לכל קטגוריה (Onboarding, גבייה, פוליסות, שירות, ועוד)
- [ ] לבנות רכיב AutomationFlowchart - תרשים זרימה ויזואלי אינטראקטיבי עם nodes, חיבורים, אנימציות
- [ ] לחבר כל כפתור הפעלה לפתיחת התרשים המתאים שלו במודל
- [ ] להוסיף אינטראקטיביות: hover על כל שלב מציג פרטים, possibly progress animation
