...
- [x] checkpoint 9aa0e50e

## Round 120 - החלפת מייל ענת בכל המקומות (אישור: להחליף בכל המקומות) (2026-05-11)
- [x] לאתר את כל המופעים של anat@sparkai.co.il / anat@spark-ai.co.il במערכת (14 קבצים)
- [x] להחליף בכולם ל-anathemell@gmail.com (קוד + טמפלייטים + הערות אם נראה לעניין)
- [x] להריץ vitest ולוודא שאין שבירות חדשות (זהה ל-baseline: 6 הקיימות מראש)
- [x] checkpoint a0006a5a

## Round 121 - הסרת "השלבים הבאים שלכם" ממסך SummaryStage (אישור: כן) (2026-05-11)
- [x] לאתר את החלק "השלבים הבאים שלכם" + 3 הקופסאות (פיילוט / 2 תהליכים / מדידת ROI) במסך הסיכום של הדמו
...
- [ ] לכתוב מדריך MD גנרי - להסיר אזכורי "קואלטי", להוסיף פסקה בולטת על דרישת Shorens, להחליף "דוח סיכום חודשי" ב"דוח מוצרים בניהול ממערכת שורנס", להסיר רשימת חברות ביטוח
- [ ] להפיק PDF גנרי
- [ ] להפיק טקסט מייל גנרי
- [ ] לספק קבצים למשתמשת


## Round 124 - מדריך משתמש מקיף (הסבר + צעד-אחר-צעד) עם צילומי מסך
- [ ] צילומי מסכים מהמערכת החיה (Home, Pricing, Onboarding, Upload, Dashboard, Triggers/Clients, Contact)
- [ ] כתיבת Markdown של מדריך עברי (RTL) משולב הסבר + הדרכת שימוש
- [ ] ייצור PDF (manus-md-to-pdf) עם בדיקת RTL וצילומים
- [ ] מסירה ללקוחה


## Round 125 — עדכון תמחיר + ניתוב מבטלים ל-checkout (2026-05-19)
- [x] איתור כל ההפניות לתמחיר הקיים (297, 3564) בלקוח/שרת/ייצוא
- [x] עדכון Pricing.tsx: חודשי 199₪, שנתי 2,028₪ (תצוגה ~169₪/חודש, חיסכון ~15%)
- [x] עדכון תוכניות בשרת (server/billing.ts, shared/copy.ts) עם הסכומים החדשים
- [x] עדכון billing.test.ts למחיר 199 (13/13 טסטים עוברים)
