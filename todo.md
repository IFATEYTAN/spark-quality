...
- [ ] להוסיף מסך הצלחה דרמטי עם אייקון V מונפש, הודעה ברורה (״תודה! ההודעה נשלחה״) ופירוט מה הלאה
- [ ] להוסיף כפתור ״סגור״ ו״שלח עוד הודעה״ במצב ההצלחה
- [ ] להבטיח שהאייקון מכוון לתפריט הנגישה (aria-live=polite)
- [ ] tsc + checkpoint
