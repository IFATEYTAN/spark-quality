...
- [ ] לבדוק למה כל הקטגוריות (VIP, השתלמות נזילה, 190, דמי ניהול גבוהים) מציגות 0 - אחרי העלאת דוח
- [ ] לבדוק למה רק 4 קטגוריות מוצגות במקום 6 (חסרים: חוסרי כיסוי, ריסק מסתיים)
- [ ] לתקן כללי קטגוריזציה כך ש-31 הלקוחות שעלו מקבלים תיוגים נכונים
- [ ] לאפשר פתיחת תרשים זרימה גם על קטגוריה ריקה (CTA "ראי את התהליך האוטומטי")
