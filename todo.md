...
- [ ] להסיר את הבאנר הירוק "זהו המסך הראשי..." מ-Dashboard.tsx (לא מתאים לעיצוב)
- [ ] לתקן רספונסיביות של מסכי הדמו (במיוחד IntroStage) - תוכן גולש מעל ה-shell, לא ממורכז כראוי
- [ ] לבדוק את כל מסכי הדמו (Splash, Intro, Upload, Analyzing, Dashboard, Actions, Summary) ולוודא שאין overflow / חיתוך / קטנים מדי
